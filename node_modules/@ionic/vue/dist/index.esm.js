...
import { setupConfig, LIFECYCLE_WILL_ENTER, LIFECYCLE_DID_ENTER, LIFECYCLE_WILL_LEAVE, LIFECYCLE_DID_LEAVE, isPlatform, actionSheetController, alertController, loadingController, modalController, pickerController, popoverController, toastController } from '@ionic/core';
...
const defineOverlayContainer = (name, componentProps = [], controller) => {
    ...
    const Container = defineComponent((props, { slots, emit }) => {
        ...
        const present = async (props) => {
            ...
            overlay.value = controller.create(Object.assign(Object.assign({}, props), { component }));
